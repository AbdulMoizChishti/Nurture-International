                                ...
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li><a href="#">Services</a>
                                            <ul class="submenu">
                                                <li>
                                                <li class="active"><a href="Air Freight.php">Air Freight</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="services-details-content">
                                <h4>How It Works?</h4>
                                <p>Air freight involves the rapid transportation of goods via aircraft. It begins with shippers preparing their cargo for air travel and delivering it to an airport or freight forwarder. At the airport, the cargo undergoes documentation, security checks, and customs clearance, then it's loaded onto specialized containers or pallets and onto cargo planes. This method is ideal for time-sensitive, high-value, or perishable goods, offering unmatched speed, although it tends to be more expensive than other transportation modes. Air freight plays a crucial role in global supply chains, facilitating swift responses to market demands and ensuring efficient deliveries..</p>
                                <div class="services-details-img">
                                    <img src="img/images/Air freight.jpeg" alt="">
                                </div>
                                <!-- <h4>Was Our Solution Best?</h4> -->
                                <p>Air freight is particularly suitable for time-sensitive cargo, perishable goods, high-value items, and products requiring rapid delivery. It offers a balance between speed and cost, although it tends to be more expensive than other modes of transportation like sea or land freight due to the higher operational costs of airlines and airports. However, the speed and reliability of air freight make it an essential component of global supply chains, allowing businesses to meet tight delivery schedules and respond quickly to changing market demands.</p>
                            </div>
                        </div>
                    </div>
                </div>
